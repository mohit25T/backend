 ...
 * 🔔 FCM TOKEN IS HANDLED HERE
 * =====================================================
 */
export const verifyUserLogin = async (req, res) => {
  try {
    // 🔔 fcmToken comes from mobile app
    ...
    if (user) {
      ...
      // This ensures notifications go ONLY to this device
      if (fcmToken) {
    ...
    // Create new user and store FCM token
